...
* None
*/
void UART1_Init(u16 BaudRate, UART1_WordLength_TypeDef WordLength, UART1_StopBits_TypeDef StopBits, UART1_Parity_TypeDef Parity, UART1_SyncMode_TypeDef SyncMode, UART1_Mode_TypeDef Mode)
{
    ...
    BaudRate_Mantissa    = ((u32)HSE_VALUE / (BaudRate << 4));
    BaudRate_Mantissa100 = (((u32)HSE_VALUE * 100) / (BaudRate << 4));
